...
func FuzzExecute(f *testing.F) {
	...
	f.Add(int64(-1), int64(5_000_000))
	f.Add(int64(1), int64(10_000_000))

	f.Fuzz(func(t *testing.T, timeoutNanos, workNanos int64) {
		...
		val, err := Execute(context.Background(), timeout,
