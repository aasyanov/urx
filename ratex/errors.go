...
var (
	// ErrCancelled is returned by [Limiter.Wait], [Limiter.WaitN], and
	// [Execute] when the context is cancelled or its deadline expires before a
	// token becomes available. The joined error carries ctx.Err(). Safe to
